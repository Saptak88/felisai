...
const Header = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        <div className="navbar p-0">
            <div className={`sidebar-top ${sidebarOpen ? "openside" : ""}`}></div>
            <div className="navbar-top pe-sm-5 ps-sm-5 pe-2 ps-2">
                <div className="d-flex align-items-center">
                    <button className={`me-2 border-none bg-transparent ${!sidebarOpen ? "d-none" : ""}`} onClick={toggleSidebar}>
                        <svg
                    ...
                    <button className={`me-2 border-none bg-transparent ${!sidebarOpen ? "d-none" : ""}`}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                ...
                <div className="dropdown">
                    ...
                    <ul className="dropdown-menu dropdown-menu-end p-2">
                        ...
                        <li>
                            <a className="dropdown-item  d-flex align-items-center mt-1 ps-1" href="/logout">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
