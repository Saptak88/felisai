        ...
        <div style={style} className="navbar p-0">
            ...
            <div className="navbar-top pe-sm-5 ps-sm-5 pe-2 ps-2">
                <div className="d-flex align-items-center">
                    ...
                    {isHomeRoute && (
                        <Link to="/" className="brand  bg-transparent border-none d-flex align-items-center">
                    ...
                    {!isHomeRoute && (
                        <div className="dropdown large-display">
                            <button
                                className="brand large-display bg-transparent border-none d-flex align-items-center dropdown-toggle"
                                type="button"
                            ...
                            <ul className="dropdown-menu p-2">
                                <li>
                                    <a href="/c" className="dropdown-item mt-1 ps-1 fw-medium">
                                        FelisAI
                                    </a>
                                </li>
                                <li>
