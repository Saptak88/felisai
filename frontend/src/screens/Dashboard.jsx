...
const Dashboard = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    const handleSendMessage = (message) => {
        ...
        setTimeout(() => {
            setMessages((prevMessages) => [...prevMessages, { text: "I am good, thank you!", sender: "bot" }]);
        }, 500);
    };
    ...
    return (
        <div className="dashboard">
            <div className={`sidebar ${sidebarOpen ? "openside" : ""}`}>
                <div className="s-top">
                    <button className={`me-2 ms-sm-5 ms-2 border-none bg-transparent `} onClick={toggleSidebar}>
                        <svg
                    ...
                    <button className="bg-transparent border-none me-2 ">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
